...
public class TestWeatherDataParser extends AndroidTestCase{
    ...
    public void testAddLocation() {
        ...
        WeatherDataParser parser = new WeatherDataParser(getContext());
        long locationId = parser.getOrAddLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
        ...
        for ( int i = 0; i < 2; i++ ) {
            ...
            long newLocationId = parser.getOrAddLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
                    ADD_LOCATION_LAT, ADD_LOCATION_LON);
